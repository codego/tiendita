...
export default function TerminosPage() {
  return (
    <LegalDoc title="Términos">
      ...
      <p>
        Con pinta muestra una selección editorial de indumentaria. Las marcas
      ...
      <p>
        Al usar Con pinta aceptás que el vínculo comercial es entre vos y la
